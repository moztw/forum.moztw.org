...
$lang = array_merge($lang, array(
	...
	'AVATAR_REMOTE_UPLOAD_TIMEOUT'		=> '指定的頭像無法上傳，因為請求逾時。',
	...
	'MODULE_NOT_FIND'		=> '不能找到模組 %s',
	'MODULE_FILE_INCORRECT_CLASS'	=> '模組檔案 %s 不包含正確的等級 [%s]',
	'MONTH'	=> '月',
	'MOVE'	=> '移動',
	'MSNM'					=> 'MSNM/WLM',
	...
	'UNABLE_GET_IMAGE_SIZE'	=> '要確定圖像的尺寸是不可能的。請確認您輸入的網址是否正確。',
